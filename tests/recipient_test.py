...
class RecipientTestCase(PagarmeTestCase):
    ...
    def test_get_recipient_by_bankAccount_id(self):
        recipient = Recipient(api_key='apikey')
        recipient.find_by_bank_account_id(17422412)
        self.assertEqual(17422412, recipient.bank_account['id'])
    ...
    def test_get_recipient_by_transfer_enabled(self):
        recipient = Recipient(api_key='apikey')
        recipient.find_by_transfer_enabled(True)
        self.assertTrue(recipient.transfer_enabled)
    ...
    def test_get_recipient_by_transfer_day(self):
        recipient = Recipient(api_key='apikey')
        recipient.find_by_transfer_day(5)
        self.assertEqual(5, recipient.transfer_day)
